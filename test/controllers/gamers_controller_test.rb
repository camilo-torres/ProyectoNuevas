...
class GamersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gamer" do
    assert_difference('Gamer.count') do
      post gamers_url, params: { gamer: { country: @gamer.country, email: @gamer.email, nickname: @gamer.nickname, password: @gamer.password } }
    end
  ...
  test "should update gamer" do
    patch gamer_url(@gamer), params: { gamer: { country: @gamer.country, email: @gamer.email, nickname: @gamer.nickname, password: @gamer.password } }
